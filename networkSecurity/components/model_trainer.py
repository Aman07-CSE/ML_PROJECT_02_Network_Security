...
from networkSecurity.entity.artifact_entity import ModelTrainerArtifacts, DataTransformationArtifact
...
import dagshub
dagshub.init(repo_owner='amancode03', repo_name='ML_PROJECT_02_Network_Security', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        preprocessor = load_object(file_path=self.data_transformation_artifact.transform_object_file_path)
