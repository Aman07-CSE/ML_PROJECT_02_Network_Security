from networkSecurity.entity.artifact_entity import DataIngestionArtifact, DataValiditonArtifacts
...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValiditonArtifacts:
        try:
            train_file_path=self.data_ingestion_artifact.trained_file_path
            test_file_path=self.data_ingestion_artifact.test_file_path
            # reading the data from tarin and test
            ...
            # IS numeric columns exist or not                                   ---------------assignment
            ...
            data_validation_artifact = DataValiditonArtifacts(
